...
,bouton_options_fenetre(ROUGE, VERT, BLEU, BLANC, {575, 600, 200, 100}, &fonc_bouton_options_fenetre, "", sing_syst->rendu, "Bouton options fenetre")
,bouton_options_retour(ROUGE, VERT, BLEU, BLANC, {100, 600, 200, 100}, &fonc_bouton_options_retour, "RETOUR", sing_syst->rendu, "Bouton options retour")
,bouton_options_touche_haut(ROUGE, VERT, BLEU, BLANC, {600, 100, 150, 60}, &fonc_choix_touche, SDL_GetKeyName(sing_syst->touches.dep_haut), sing_syst->rendu, "Bouton options touche haut")
,bouton_options_touche_bas(ROUGE, VERT, BLEU, BLANC, {600, 180, 150, 60}, &fonc_choix_touche, SDL_GetKeyName(sing_syst->touches.dep_bas), sing_syst->rendu, "Bouton options touche bas")
,bouton_options_touche_gauche(ROUGE, VERT, BLEU, BLANC, {600, 260, 150, 60}, &fonc_choix_touche, SDL_GetKeyName(sing_syst->touches.dep_gauche), sing_syst->rendu, "Bouton options touche gauche")
,bouton_options_touche_droite(ROUGE, VERT, BLEU, BLANC, {600, 340, 150, 60}, &fonc_choix_touche, SDL_GetKeyName(sing_syst->touches.dep_droite), sing_syst->rendu, "Bouton options touche droite")
